...
Defines ordering semantics for Release CRs: how `spec.dependsOn` blocks reconciliation until referenced Releases are `Ready=True`, and the namespace scope of those references.
